...
caselist.remove('tpe20140525nor')

for casename in caselist:
  file_path = path+'/taiwanVVM/'+casename+'/fort.98'
  ...
  #===LIFT FROM SURFACE=====================================================================
  cape,cin,lfc,el=compute_CAPE_AND_CIN(T_fine,P_fine,Q_fine,0,0,0,Z_fine,T1,T2)
  print("T_fine:",cape,cin,lfc,el,"case=",casename)
  ...
  Td_fine[P_fine<30000.]=np.nan
  Td_fine_warm[P_fine_warm<30000.]=np.nan
