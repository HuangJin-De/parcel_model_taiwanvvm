Module share
IMPLICIT NONE
INTEGER, PARAMETER   :: NX=261, NY=97, NZ=32, MISS=-32767 
REAL*8, PARAMETER    :: alpha=0.5,& 
                        ...
                        cvv=cpv-rv,& 
                        epsilon=rd/rv
INTEGER, PARAMETER   :: PEVARN = 5, SFCVARN = 6
CHARACTER            :: pevar(PEVARN)*100, sfcvar(SFCVARN)*100
CHARACTER            :: pevar_name(PEVARN)*100
REAL*8,   DIMENSION(NZ)  :: pl
INTEGER,  DIMENSION(12)  :: dlist

DATA pevar/'t','q','z','u','v'/
DATA sfcvar/'z','sp','u10','v10','t2m','d2m'/
!DATA pevar_name/'temperature [K]',&
!                'specific humidity [kg/kg]',&
!                'geopotential [m2/s2]'/
DATA pl/10, 20, 30, 50, 70, 100, 125, 150, 175, 200, 225,&
