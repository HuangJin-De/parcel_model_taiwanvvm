...
for casename in caselist:
  ...
  wmax_loc=np.argmax(vvm_w[0:nw,n])
  ...
  ax.plot(vvm_w_x[wmax_loc,n],vvm_w_y[wmax_loc,n],'r*',markersize=4,alpha=0.7)
  ax.plot(dnx,dny,'m*',markersize=4,alpha=0.7)
  ...
  #plt.show()
  plt.savefig("./figure/hotspot_"+casename+".png")
  plt.close()
